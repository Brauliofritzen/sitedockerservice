		...
		<div class="container">
			...
			<div class="span12" style="text-align:center; margin: 0 auto;">
				<form method="POST" action="confere_login.php">
					...
					<input type="submit" name="btnLogin" value="Acessar" class="btn btn-success btn-block"><br>
					
					<a href="recuperar_senha.php" class="btn btn-info btn-sm active" role="button" aria-pressed="true">Esqueceu a senha</a>
