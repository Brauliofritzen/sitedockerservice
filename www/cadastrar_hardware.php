...
<html lang="pt-br">
	...
	if(isset($_SESSION['msg'])){
		...
		?>
				<h2 class="text-center">Cadastro de hardware</h2>
		
			<div class="span12" style="text-align:center; margin: 0 auto;">
				
				<form method="POST" action="inclui_hardware.php">
				
					<div class="form-group row">
							  <label for="modelo_equipamento" class="col-3 col-form-label">Hardware</label>
							  <div class="col-9">
								<input type="text" name="modelo_equipamento" placeholder="Tipo do hardware/equipamento" class="form-control">
							  </div>
							</div>
							<div class="form-group row">
							  <label for="marca_equipamento" class="col-3 col-form-label">Marca</label>
							  <div class="col-9">
								<input type="text" name="marca_equipamento" placeholder="Fabricante do hardware" class="form-control">
							  </div>
							</div>
							<div class="form-group row">
							  <label for="serie" class="col-3 col-form-label">Serial</label>
							  <div class="col-9">
								<input type="text" name="serie" placeholder="Numero de serie" class="form-control">
							  </div>
							</div>
							<div class="form-group row">
							  <label for="patrimonio" class="col-3 col-form-label">Patrimonio</label>
							  <div class="col-9">
								<input type="int" name="patrimonio" placeholder="Numero de patrimonio" class="form-control">
							  </div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
							  <label for="data_vencimento" class="col-3 col-form-label">Vencimento da garantia</label>
							  <div class="col-9">
							...
							<div class="form-group row">
							  <label for="descricao" class="col-3 col-form-label">Descrição do equipamento</label>
							  <div class="col-9">
								<input type="text" name="descricao" placeholder="Breve descrição do equipamento" class="form-control">
							  </div>
							</div>
