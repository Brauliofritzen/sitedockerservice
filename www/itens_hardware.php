...
<html lang="pt-br">
	...
	<body>	
		...
		<div class="container">
			...
			<?php
				...
				$result_lista = "SELECT * FROM hardware WHERE email = '$logado'";
	...
	if(isset($_SESSION['msg'])){
		...
		<div class="container theme-showcase" role="main">
			<div class="page-header">
				<h1 align="center">Hardware cadastrado</h1>
			</div>
			<div class="row">
				<div class="col-md-12">
					<table id="lista" class="table">
						...
						<tbody>
			          		<?php while($rows_lista = mysqli_fetch_assoc($resultado_lista)){ ?>
			          			...
			          			<tr>
									<td><?php echo $rows_lista['modelo_equipamento']; ?></td>
									<td><?php echo $rows_lista['marca_equipamento']; ?></td>
								...
								<td>
									<button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#viModal" data-whatever="<?php echo $rows_lista['id_hardware']; ?>" data-whatevermodelo="<?php echo $rows_lista['modelo_equipamento']; ?>"data-whatevermarca="<?php echo $rows_lista['marca_equipamento']; ?>" data-whateverserie="<?php echo $rows_lista['serie']; ?>"data-whateverpatrimonio="<?php echo $rows_lista['patrimonio']; ?>" data-whatevercompra="<?php echo $rows_lista['data_compra']; ?>" data-whatevervencimento="<?php echo $rows_lista['data_vencimento']; ?>" data-whateveraviso="<?php echo $rows_lista['data_aviso']; ?>" data-whateveremail="<?php echo $rows_lista['email']; ?>" data-whateveropcional="<?php echo $rows_lista['email_opcional']; ?>" data-whateverdescricao="<?php echo $rows_lista['descricao_equipamento']; ?>">Visualizar</button>
																			
									<button type="button" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#edModal" data-whatever="<?php echo $rows_lista['id_hardware']; ?>" data-whatevermodelo="<?php echo $rows_lista['modelo_equipamento']; ?>"data-whatevermarca="<?php echo $rows_lista['marca_equipamento']; ?>" data-whateverserie="<?php echo $rows_lista['serie']; ?>"data-whateverpatrimonio="<?php echo $rows_lista['patrimonio']; ?>" data-whatevercompra="<?php echo $rows_lista['data_compra']; ?>" data-whatevervencimento="<?php echo $rows_lista['data_vencimento']; ?>" data-whateveraviso="<?php echo $rows_lista['data_aviso']; ?>" data-whateveremail="<?php echo $rows_lista['email']; ?>" data-whateveropcional="<?php echo $rows_lista['email_opcional']; ?>" data-whateverdescricao="<?php echo $rows_lista['descricao_equipamento']; ?>">Editar</button>
									
									<button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#deModal" data-whatever="<?php echo $rows_lista['id_hardware']; ?>" data-whatevermodelo="<?php echo $rows_lista['modelo_equipamento']; ?>"data-whatevermarca="<?php echo $rows_lista['marca_equipamento']; ?>">Delete</button>
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<form method="POST" action="data_hardware.php" enctype="multipart/form-data"/>
				  <div class="form-group">
					<label for="recipient-name" class="control-label">Modelo do equipamento:</label>
					<input name="modelo_equipamento" type="text" class="form-control" id="modelo_equipamento"/>
				  </div>
				  <div class="form-group">
					<label for="recipient-name" class="control-label">Marca do equipamento:</label>
					<input name="marca_equipamento" type="text" class="form-control" id="marca_equipamento"disabled/>
				  </div>
				  <div class="form-group">
					<label for="recipient-name" class="control-label">Serie:</label>
					<input name="serie" type="text" class="form-control" id="serie"disabled/>
				  </div>
				  <div class="form-group">
					<label for="recipient-name" class="control-label">Patrimonio:</label>
					<input name="patrimonio" type="text" class="form-control" id="patrimonio"disabled/>
				  </div>
				   <div class="form-group">
				 ...
				 <div class="form-group">
					<label for="recipient-name" class="control-label">Descrição do equipamento:</label>
					<input name="descricao_equipamento" type="text" class="form-control" id="descricao_equipamento"disabled/>
				  </div>
				<input name="id_hardware" type="hidden" class="form-control" id="id_hardware" value="">
		 ...
		 <div class="modal fade" id="edModal" tabindex="-1" role="dialog" aria-labelledby="edModalLabel">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<form method="POST" action="atualiza_hardware.php" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
					<label for="recipient-name" class="control-label">Marca do equipamento:</label>
					<input name="marca_equipamento" type="text" class="form-control" id="marca_equipamento">
				  </div>
				  <div class="form-group">
					<label for="recipient-name" class="control-label">Serie:</label>
				 ...
				 <div class="form-group">
					<label for="recipient-name" class="control-label">Descrição do equipamento:</label>
					<input name="descricao_equipamento" type="text" class="form-control" id="descricao_equipamento">
				  </div>
				<input name="id_hardware" type="hidden" class="form-control" id="id_hardware" value="">
		 ...
		 <div class="modal fade" id="deModal" tabindex="-1" role="dialog" aria-labelledby="deModalLabel">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<form method="POST" action="apagar_hardware.php" enctype="multipart/form-data">
				  <div class="form-group">
					<label for="recipient-name" class="control-label">Modelo do equipamento:</label>
					<input name="modelo_equipamento" type="text" class="form-control" id="modelo_equipamento">
				  </div>
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
		...
		$('#viModal').on('show.bs.modal', function (event) {
		  ...
		  var recipientpatrimonio = button.data('whateverpatrimonio')
		 ...
		 var recipient = button.data('whatever')
		  ...
		  modal.find('#modelo_equipamento').val(recipientmodelo)
		  modal.find('#marca_equipamento').val(recipientmarca)
		  modal.find('#serie').val(recipientserie)
		  modal.find('#patrimonio').val(recipientpatrimonio)
		  ...
		  modal.find('#descricao_equipamento').val(recipientdescricao)
		  modal.find('#id_hardware').val(recipient)
