		...
		<div class="container">
			...
			<div class="span12" style="text-align:center; margin: 0 auto;">
				<form method="POST" action="cria_usuario.php">
					...
					<input type="text" name="empresa" placeholder="Digite o nome da empresa" class="form-control"><br>
					
					<input type="password" name="senha" placeholder="Senha minimo 8 digitos" class="form-control"><br>
					<input type="password" name="conf_senha" placeholder="Confirme a senha" class="form-control"><br>
					
					<input type="submit" name="btnLogin" value="Cadastrar" class="btn btn-success btn-block"><br><br>
