...
<html lang="pt-br">
	...
	<body>	
		...
		<div class="container">
			...
			<?php
				...
				$result_data= "SELECT distinct * from data_software WHERE recebe_id_software='$idsoftware' GROUP BY recebe_data_software";
	...
	if(isset($_SESSION['msg'])){
		...
		<div class="container theme-showcase" role="main">
			...
			<div class="row">
				<div class="col-md-12">
					<table id="software" class="table">
						<thead>
							<tr>
								<th>Data em que foi alterado <?php echo $nome; ?></th>
						...
						<tbody>
			          		<?php while($rows_data = mysqli_fetch_assoc($resultado_data)){ ?>
			          			...
			          			<tr>
									<td><?php echo date('d/m/Y H:i:s',strtotime($rows_data['data_alteracao_software'])); ?></td>
									<td><?php echo implode('/', array_reverse(explode('-', $rows_data['recebe_data_software']))); ?></td>
								</tr>
								<?php } ?>
								</tbody>
								</table>
